...
export function renderMemoryJson(candidate: MemoryCandidate): string {
...
async function writeMemoryFile(config: HookConfig, candidate: MemoryCandidate): Promise<string> {
